...
namespace ItemSmithWorkShop.WeaponUtilities
{
	public class TempWeaponDictionary : AdventureItem
	{
		...
		private static void LoadWeaponDictionary()
		{
			...
			{
				{ "Dagger", new WeaponData { WeaponName = "Dagger", WeaponCategory = "Light Melee", WeaponProficiencyRequirement = "Simple Weapon", WeaponDamage = "1d4", WeaponThreatRange = "19-20", WeaponCritical = "x2", WeaponDamageType = "Piercing or Slashing", WeaponHardness = 10, WeaponHitPoints = 2, BasePrice = 2, WeaponWeight = 1, WeaponText = string.Format("Dagger: The dagger is a common secondary weapon. You get a +2 bonus on{0}\tSleight of Hand checks made to conceal a dagger on your body.", Environment.NewLine) } },
				{ "Short Sword", new WeaponData { WeaponName = "Short Sword", WeaponCategory = "Light Melee", WeaponProficiencyRequirement = "Martial Weapon", WeaponDamage = "1d6", WeaponThreatRange = "19-20", WeaponCritical = "x2", WeaponDamageType = "Slashing", WeaponHardness = 10, WeaponHitPoints = 2, BasePrice = 10, WeaponWeight = 2, WeaponText = "Short Sword: This sword is popular as an off-hand weapon." } },
